 ...
 */
final class Version20220222172537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE app_user (id INT NOT NULL, company_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, gender BOOLEAN DEFAULT NULL, is_pending BOOLEAN NOT NULL, is_valid BOOLEAN NOT NULL, score INT NOT NULL, register_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, last_update TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, last_connection_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, hash VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE question (id INT NOT NULL, survey_id INT NOT NULL, text TEXT NOT NULL, is_required BOOLEAN DEFAULT \'false\' NOT NULL, choices JSON NOT NULL, choices_type VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
