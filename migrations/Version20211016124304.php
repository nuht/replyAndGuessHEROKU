 ...
 */
final class Version20211016124304 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE app_user (id INT NOT NULL, company_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, gender BOOLEAN DEFAULT NULL, is_pending BOOLEAN NOT NULL, is_valid BOOLEAN NOT NULL, score INT NOT NULL, register_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, last_update TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, last_connection_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, birthdate DATE DEFAULT NULL, hash VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE question (id INT NOT NULL, multiple_id INT DEFAULT NULL, text_area_id INT DEFAULT NULL, survey_id INT NOT NULL, text TEXT NOT NULL, is_required BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE result (id INT NOT NULL, survey_id INT NOT NULL, user_id_id INT NOT NULL, answer_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, value JSON DEFAULT NULL, value_predict JSON DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE survey (id INT NOT NULL, user_id_id INT NOT NULL, published_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, closed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, status VARCHAR(255) NOT NULL, config_settings JSON DEFAULT NULL, hash VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_AD5F9BFC9D86650F ON survey (user_id_id)');
        ...
        $this->addSql('ALTER TABLE result ADD CONSTRAINT FK_136AC1139D86650F FOREIGN KEY (user_id_id) REFERENCES app_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE survey ADD CONSTRAINT FK_AD5F9BFC9D86650F FOREIGN KEY (user_id_id) REFERENCES app_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE survey DROP CONSTRAINT FK_AD5F9BFC9D86650F');
